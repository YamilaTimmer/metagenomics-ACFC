...
![Overview of pipeline steps, including the pre-processing steps that were not performed by us (gray) and the steps that were executed by us (blue).]("/home/floris/Documenten/git_repo/metagenomics-ACFC/analysis/Logbook_Floris/Workflow_Diagram.jpg")
...
![A pie chart showing the microbial diversity of the lagoon influent, generated using Krona.]("/home/floris/Documenten/git_repo/metagenomics-ACFC/analysis/Logbook_Yamila/img/krona_in_lagoon.png")

\

\

![A pie chart showing the microbial diversity of the lagoon effluent, generated using Krona.]("/home/floris/Documenten/git_repo/metagenomics-ACFC/analysis/Logbook_Yamila/img/krona_in_lagoon.png")

\

\

![Sankey chart visualizing taxonomic diversity of lagoon influent, generated with Pavian.]("/home/floris/Documenten/git_repo/metagenomics-ACFC/analysis/Logbook_Floris/In_Lagoon.png")

\

\

![Sankey chart visualizing taxonomic diversity of lagoon effluent, generated with Pavian.]("/home/floris/Documenten/git_repo/metagenomics-ACFC/analysis/Logbook_Floris/Out_Lagoon.png")
...
The classified species were compared to the FAPROTAX database and from here certain (metabolic) pathways were found (fig. 5). The lagoon in contains OTU's that are known to play a role in the following eight pathways: sulfur respiration, sulfite respiration, sulfate respiration, respiration of sulfur compounds, iron respiration, fermentation, chemoheterotrophy and aromatic compound degeneration. The last three being the pathways with the highest abundance. The lagoon out contains OTU's that are known to play a role in the following three pathways: fermentation, chemoheterotrophy and aromatic compound degeneration. These three pathways seem to overlap with the three pathways with the highest abundance of the lagoon in sample. Chemoheterotrophy and aromatic compound degeneration seem to have an equal abundance in both samples, while fermentation seems to have a higher abundance in the out_lagoon sample. 
\

\

![Comparison of read abundance signifying the presence of pathways across samples.](/home/floris/Documenten/git_repo/metagenomics-ACFC/analysis/Logbook_Floris/Bubble_chart.png)
