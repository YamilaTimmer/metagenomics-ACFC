...
no effect on the genetic material in the samples. 

## **1. Quality control** ##
To check the quality of the raw sequence data, Fastplong was used.
...
# Use lfcschrink to do a log transformation on the data:
...
```
The graph above displays the results of the FAPROTAX analysis. This is a database with microorganisms and their known functions.
FAPROTAX maintains a database of Over 7600 functional annotations covering over 4600 taxa.
...
This difference can be partially atributed to a large difference in reads between the two samples. 
