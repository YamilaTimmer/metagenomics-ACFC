...
The main objective of this study was to identify the microorganisms present in the digester, lagoon in and lagoon out samples. Due problems with the quality of the flowcell that was used for sequecing with a Nanopore, the digester sample only contained two reads, one of which was remove during trimming with Fastplong. This sample was unusable for further analyses and was discarded. 
...
Even though species level data is not available due the use of 16S rRNA, some species of Clostridia are know to produce toxins. Clostridium botulinum produces the neurotoxin botulinum but the precence of this specific bacterium is speculation. 
